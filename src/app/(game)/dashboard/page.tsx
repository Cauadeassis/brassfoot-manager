...
import UserTeamStats from "./_components/userTeamStats";
import MatchList from "./_components/matchList";
import MiniStandings from "./_components/miniStandings";
...
export default function Dashboard() {
  ...
  const nationalLeagueId =
    `${userTeam.nationality}_league_${userTeam.division}` as CompetitionId;
